                ...
                case itINT8:
                    ...
                    for (quint32 jy = jMinY; jy < jMaxY; ++jy) {
                        for (quint32 jx = jMinX; jx < jMaxX; ++jx) {
                            ...
                            values[tilerow * _y_pixels_tile * gridblock_x_size + tilecol * _x_pixels_tile + jy * gridblock_x_size + jx] = (_hasNodataValue[layerNr] && (_noDataValues[layerNr] == b))  ? rUNDEF : b;
                        }
                    }
                    break;
                case itUINT8:
                    ...
                    tileHex += 2 * sizeof(qint16);
                    {
                        ...
                        for (quint32 jy = jMinY; jy < jMaxY; ++jy) {
                            for (quint32 jx = jMinX; jx < jMaxX; ++jx) {
                                ...
                                values[tilerow * _y_pixels_tile * gridblock_x_size + tilecol * _x_pixels_tile + jy * gridblock_x_size + jx] = (_hasNodataValue[layerNr] && (_noDataValues[layerNr] == hl)) ? rUNDEF : hl;
                            }
                        }
                    }
                    break;
