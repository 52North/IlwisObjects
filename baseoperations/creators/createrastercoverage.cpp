...
quint64 CreateRasterCoverage::createMetadata()
{
     ...
     resource.addOptionalInParameter(4, itSTRING|itINTEGER|itRASTER,TR("Stack definition"), TR("Content of the stack, numbers, elements of item domain,raster bands or sets of numbers"));
